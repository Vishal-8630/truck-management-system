    ...
    <div className="card-premium p-0 overflow-hidden hover:-translate-y-1 transition-all duration-300 group cursor-pointer border-slate-100 h-full flex flex-col">
      <div className="bg-blue-600 p-6 flex items-center justify-between text-white">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-bold uppercase tracking-widest opacity-70 italic">Truck Plate</span>
            <span className="text-lg font-black uppercase tracking-tight leading-none">{journey.truck.truck_no}</span>
          </div>
        </div>
        <div className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-blue-600 transition-colors">
      ...
      <div className="p-6 flex flex-col gap-6 flex-1">
        <div className="flex items-center gap-4 p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Driver</span>
            <span className="font-bold text-slate-700">{(journey.driver as any)?.name || "N/A"}</span>
          </div>
        </div>
        ...
        <div className="mt-auto pt-6 border-t border-slate-50 grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col text-right">
            ...
            <span className="text-sm font-black text-blue-600 italic">₹{journey.total_expense || "0"}</span>
          </div>
        </div>
      </div>
    </div>
