...
import { Wallet, Clock, UserSquare, Plus, Milestone, Calculator } from "lucide-react";
...
const VehicleEntryForm: React.FC<VehicleEntryFormProps> = ({
    vehicleEntry,
    errors,
    isPending,
    partyRef,
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-4 flex flex-col gap-8 sticky top-24">
                    ...
                    <div className="bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30 rounded-[2rem] p-6 flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex items-center justify-between text-[11px]">
                                ...
                                <span className="text-blue-600 dark:text-blue-400 font-black font-heading">Gross - Deductions</span>
                            </div>
                        </div>
                    </div>
