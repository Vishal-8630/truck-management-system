                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-slate-50 gap-2">
                                        <div className="flex flex-col gap-0.5">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest border ${settlement.payment_status === "Balanced" ? "bg-emerald-50 text-emerald-600 border-emerald-100" :
                                                        settlement.payment_status === "Driver needs to pay" ? "bg-amber-50 text-amber-600 border-amber-200" :
