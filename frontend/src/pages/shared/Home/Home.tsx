      ...
      <section className="relative">
        ...
        <div className="max-w-4xl mx-auto p-12 lg:p-20 flex flex-col items-center text-center gap-10">
          <div className="flex flex-col gap-4">
            <h2 className="text-3xl lg:text-5xl font-bold tracking-tight">Track Your <span className="text-indigo-600">Shipment</span></h2>
            <p className="text-slate-500">Enter your LR Number or Waybill to get real-time status updates.</p>
          </div>
